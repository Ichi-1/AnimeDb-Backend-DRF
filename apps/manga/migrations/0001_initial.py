    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Reading', 'Reading'), ('Plan to read', 'Plan To Read'), ('Completed', 'Completed'), ('Dropped', 'Dropped')], max_length=15)),
                ('num_chapters_readed', models.PositiveIntegerField(null=True, validators=[django.core.validators.MaxValueValidator(7774)], verbose_name='Number of readed chapters')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manga', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='manga_review', to='manga.manga')),
            ],
            options={
                'abstract': False,
