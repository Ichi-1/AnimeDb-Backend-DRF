    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.ImageField(upload_to=apps.anime.utils.utils.get_path_upload_screenshot, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['jpg', 'png'])])),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('anime', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='screenshot', to='anime.anime')),
            ],
        ),
        migrations.CreateModel(
            name='MyAnimeList',
            fields=[
                ...
                ('num_episodes_watched', models.PositiveIntegerField(null=True, validators=[django.core.validators.MaxValueValidator(100)], verbose_name='Number of watched episodes')),
                ('anime', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='my_list', to='anime.anime')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('anime', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='anime_review', to='anime.anime')),
            ],
            options={
                'abstract': False,
